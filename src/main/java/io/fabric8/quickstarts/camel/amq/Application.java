...
public class Application {
	...
	ActiveMQComponent activemqComponent(AMQConfiguration config) {
		ActiveMQConnectionFactory cf = new ActiveMQConnectionFactory(config.getUsername(), config.getPassword(), "tcp://" + config.getHost() + ":" + config.getPort());
